...
class commotions_markkula_NI_BEEFS_ADE(model_template, commotions_template):
    def setup_method(self):
        # set model settings
        self.adjust_free_speeds = True
        self.vehicle_acc_ctrl = True
    ...
    def train_method(self):
        ...
        Params, Loss = self.BO_EI(iterations = 150)
        
        self.param_best = Params[np.argmin(Loss), :]
        
        self.weights_saved = [self.param_best, Params, Loss]
    ...
    def get_name(self):
        return 'commotions_expanded_non_inter_FS_BO_EI_ADE'