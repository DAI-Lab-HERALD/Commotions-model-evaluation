...
Data_sets = ['CoR_left_turns', 'Commotions_crossing_reduced', 'RounD_round_about_reduced']
Metrics = ['ROC_curve', 'ROC_curve_col', 'ADE', 'Time_CDF', 'Useless_brake']
Data_params = [{'dt': 0.2, 'num_timesteps_in': (2, n_I_max)}] 
Splitters = ['Critical_split']
Models = ['commotions_markkula_BEESFS_ADE', 
          'commotions_markkula_BEETFS_ADE', 
          'commotions_markkula_NI_BEESFS_ADE']




##### Unavailable combinations
Not_allowed_combinations = [['commotions_markkula_DE', {'dt': 0.2, 'num_timesteps_in': (3, n_I_max)}],
                            ['commotions_markkula_DE', {'dt': 0.2, 'num_timesteps_in': n_I_max}],
                            ['commotions_markkula_DE', 'Commotions_crossing'],]
